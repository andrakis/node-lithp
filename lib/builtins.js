...
builtin('if/2', ['Test', 'Action'], function(Test, Action, State) {
	// Alias to if/3
	return builtins['if/3'].call(this, Test, Action, new OpChain(State), State);
});
builtin('if/3', ['Test', 'Action', 'Else'], function(Test, Action, Else) {
	if(Test == Atom('true'))
