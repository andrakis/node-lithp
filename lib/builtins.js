...
builtin('inspect/1', ['Object'], function(O) { return this.inspect_object([O]); });
builtin('null', [], () => null);
...
builtin("acos", ['N'], N => Math.acos(N));
builtin("acosh", ['N'], N => Math.acosh(N));
builtin("asin", ['N'], N => Math.asin(N));
builtin("asinh", ['N'], N => Math.asinh(N));
builtin("atan", ['N'], N => Math.atan(N));
builtin("atanh", ['N'], N => Math.atanh(N));
builtin("cbrt", ['N'], N => Math.cbrt(N));
builtin("ceil", ['N'], N => Math.ceil(N));
builtin("clz32", ['N'], N => Math.clz32(N));
builtin("cos", ['N'], N => Math.cos(N));
builtin("cosh", ['N'], N => Math.cosh(N));
builtin("exp", ['N'], N => Math.exp(N));
builtin("expm1", ['N'], N => Math.expm1(N));
builtin("floor", ['N'], N => Math.floor(N));
builtin("fround", ['N'], N => Math.fround(N));
builtin("hypot", ['N'], N => Math.hypot(N));
builtin("imul", ['N'], N => Math.imul(N));
builtin("log", ['N'], N => Math.log(N));
builtin("log10", ['N'], N => Math.log10(N));
builtin("log1p", ['N'], N => Math.log1p(N));
builtin("log2", ['N'], N => Math.log2(N));
builtin("max", ['N'], N => Math.max(N));
builtin("min", ['N'], N => Math.min(N));
builtin("pow", ['N'], N => Math.pow(N));
builtin("round", ['N'], N => Math.round(N));
builtin("sign", ['N'], N => Math.sign(N));
builtin("sin", ['N'], N => Math.sin(N));
builtin("sinh", ['N'], N => Math.sinh(N));
builtin("sqrt", ['N'], N => Math.sqrt(N));
builtin("tan", ['N'], N => Math.tan(N));
builtin("tanh", ['N'], N => Math.tanh(N));
builtin("trunc", ['N'], N => Math.trunc(N));
...
builtin('recurse/*', ['Args'], function(Args, State) {
	var Fn = builtins['head'].body.call(this, Args);
	var Params = builtins['tail'].body.call(this, Args);

	// Target the call chain above this.
	...
	if(fndef == atomMissing) {
		...
		if(fndef == atomMissing) {
			throw new Error('Error, unknown function: ' + i.FnAndArity);
		}
	}
